...
@XmlRootElement(name = "ArchiveRuntimeEventResponse")
public class ArchiveRuntimeEventResponse
    extends Status
{
     ...
     * 
     */
    public ArchiveRuntimeEventResponse() {
        super();
    }
     ...
     * 
     */
    public ArchiveRuntimeEventResponse(final long code, final String msg, final List<RootCause> rootCause, final List<RuntimeEventArchive> runtimeEventArchive) {
    ...
    public ArchiveRuntimeEventResponse withRuntimeEventArchive(RuntimeEventArchive... values) {
        if (values!= null) {
    ...
    public ArchiveRuntimeEventResponse withRuntimeEventArchive(Collection<RuntimeEventArchive> values) {
        if (values!= null) {
    ...
    public ArchiveRuntimeEventResponse withRuntimeEventArchive(List<RuntimeEventArchive> runtimeEventArchive) {
        setRuntimeEventArchive(runtimeEventArchive);
        return this;
    }

    @Override
    public ArchiveRuntimeEventResponse withCode(long value) {
        setCode(value);
        return this;
    }

    @Override
    public ArchiveRuntimeEventResponse withMsg(String value) {
        setMsg(value);
        return this;
    }

    @Override
    public ArchiveRuntimeEventResponse withRootCause(RootCause... values) {
        if (values!= null) {
    ...
    @Override
    public ArchiveRuntimeEventResponse withRootCause(Collection<RootCause> values) {
        if (values!= null) {
    ...
    @Override
    public ArchiveRuntimeEventResponse withRootCause(List<RootCause> rootCause) {
