...
@XmlRootElement(name = "ProjectMetaDataValuesListRequest")
public class ProjectMetaDataValuesListRequest {
     ...
     * 
     */
    public ProjectMetaDataValuesListRequest() {
        super();
    }
     ...
     * 
     */
    public ProjectMetaDataValuesListRequest(final long projectVersionId) {
    ...
    public ProjectMetaDataValuesListRequest withProjectVersionId(long value) {
