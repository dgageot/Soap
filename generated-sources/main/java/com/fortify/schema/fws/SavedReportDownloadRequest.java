...
@XmlRootElement(name = "SavedReportDownloadRequest")
public class SavedReportDownloadRequest {
     ...
     * 
     */
    public SavedReportDownloadRequest() {
        super();
    }
     ...
     * 
     */
    public SavedReportDownloadRequest(final long savedReportId) {
    ...
    public SavedReportDownloadRequest withSavedReportId(long value) {
