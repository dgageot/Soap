...
@XmlRootElement(name = "RestoreRuntimeEventRequest")
public class RestoreRuntimeEventRequest {
     ...
     * 
     */
    public RestoreRuntimeEventRequest() {
        super();
    }
     ...
     * 
     */
    public RestoreRuntimeEventRequest(final long runtimeEventArchiveId) {
    ...
    public RestoreRuntimeEventRequest withRuntimeEventArchiveId(long value) {
