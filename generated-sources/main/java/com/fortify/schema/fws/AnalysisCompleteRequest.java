...
@XmlRootElement(name = "AnalysisCompleteRequest")
public class AnalysisCompleteRequest {
     ...
     * 
     */
    public AnalysisCompleteRequest() {
        super();
    }
     ...
     * 
     */
    public AnalysisCompleteRequest(final ProjectIdentifier projectVersionId, final Boolean expectsAttachment) {
    ...
    public AnalysisCompleteRequest withProjectVersionId(ProjectIdentifier value) {
        setProjectVersionId(value);
        return this;
    }

    public AnalysisCompleteRequest withExpectsAttachment(Boolean value) {
