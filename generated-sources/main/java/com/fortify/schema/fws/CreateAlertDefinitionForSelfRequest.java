...
@XmlRootElement(name = "CreateAlertDefinitionForSelfRequest")
public class CreateAlertDefinitionForSelfRequest {
     ...
     * 
     */
    public CreateAlertDefinitionForSelfRequest() {
        super();
    }
     ...
     * 
     */
    public CreateAlertDefinitionForSelfRequest(final List<Long> projectVersionIds, final AlertDefinition alertDefinition) {
    ...
    public CreateAlertDefinitionForSelfRequest withProjectVersionIds(Long... values) {
        if (values!= null) {
    ...
    public CreateAlertDefinitionForSelfRequest withProjectVersionIds(Collection<Long> values) {
        if (values!= null) {
    ...
    public CreateAlertDefinitionForSelfRequest withAlertDefinition(AlertDefinition value) {
        setAlertDefinition(value);
        return this;
    }

    public CreateAlertDefinitionForSelfRequest withProjectVersionIds(List<Long> projectVersionIds) {
