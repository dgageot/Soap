...
@XmlRootElement(name = "PerformanceIndicatorListResponse")
public class PerformanceIndicatorListResponse
    extends Status
{
     ...
     * 
     */
    public PerformanceIndicatorListResponse() {
        super();
    }
     ...
     * 
     */
    public PerformanceIndicatorListResponse(final long code, final String msg, final List<RootCause> rootCause, final PerformanceIndicatorDefinition performanceIndicatorDefinition) {
    ...
    public PerformanceIndicatorListResponse withPerformanceIndicatorDefinition(PerformanceIndicatorDefinition value) {
        setPerformanceIndicatorDefinition(value);
        return this;
    }

    @Override
    public PerformanceIndicatorListResponse withCode(long value) {
        setCode(value);
        return this;
    }

    @Override
    public PerformanceIndicatorListResponse withMsg(String value) {
        setMsg(value);
        return this;
    }

    @Override
    public PerformanceIndicatorListResponse withRootCause(RootCause... values) {
        if (values!= null) {
    ...
    @Override
    public PerformanceIndicatorListResponse withRootCause(Collection<RootCause> values) {
        if (values!= null) {
    ...
    @Override
    public PerformanceIndicatorListResponse withRootCause(List<RootCause> rootCause) {
