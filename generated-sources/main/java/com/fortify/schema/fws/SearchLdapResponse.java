...
@XmlRootElement(name = "SearchLdapResponse")
public class SearchLdapResponse
    extends Status
{
     ...
     * 
     */
    public SearchLdapResponse(final long code, final String msg, final List<RootCause> rootCause, final List<LdapEntity> ldapEntity) {
    ...
    public SearchLdapResponse withLdapEntity(LdapEntity... values) {
        if (values!= null) {
    ...
    public SearchLdapResponse withLdapEntity(Collection<LdapEntity> values) {
        if (values!= null) {
    ...
    public SearchLdapResponse withLdapEntity(List<LdapEntity> ldapEntity) {
        setLdapEntity(ldapEntity);
        return this;
    }

    @Override
    public SearchLdapResponse withCode(long value) {
        setCode(value);
        return this;
    }

    @Override
    public SearchLdapResponse withMsg(String value) {
        setMsg(value);
        return this;
    }

    @Override
    public SearchLdapResponse withRootCause(RootCause... values) {
        if (values!= null) {
    ...
    @Override
    public SearchLdapResponse withRootCause(Collection<RootCause> values) {
        if (values!= null) {
    ...
    @Override
    public SearchLdapResponse withRootCause(List<RootCause> rootCause) {
