...
@XmlRootElement(name = "AnalysisPayloadDownloadRequest")
public class AnalysisPayloadDownloadRequest {
     ...
     * 
     */
    public AnalysisPayloadDownloadRequest() {
        super();
    }
     ...
     * 
     */
    public AnalysisPayloadDownloadRequest(final ProjectIdentifier projectVersionId) {
    ...
    public AnalysisPayloadDownloadRequest withProjectVersionId(ProjectIdentifier value) {
