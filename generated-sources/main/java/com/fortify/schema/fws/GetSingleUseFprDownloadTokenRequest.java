...
@XmlRootElement(name = "GetSingleUseFPRDownloadTokenRequest")
public class GetSingleUseFprDownloadTokenRequest {
     ...
     * 
     */
    public GetSingleUseFprDownloadTokenRequest() {
        super();
    }
     ...
     * 
     */
    public GetSingleUseFprDownloadTokenRequest(final BigInteger daysToLive) {
    ...
    public GetSingleUseFprDownloadTokenRequest withDaysToLive(BigInteger value) {
        setDaysToLive(value);
        return this;
    }
