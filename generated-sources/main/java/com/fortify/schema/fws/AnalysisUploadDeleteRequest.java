...
@XmlRootElement(name = "AnalysisUploadDeleteRequest")
public class AnalysisUploadDeleteRequest {
     ...
     * 
     */
    public AnalysisUploadDeleteRequest() {
        super();
    }
     ...
     * 
     */
    public AnalysisUploadDeleteRequest(final ProjectIdentifier projectVersionId) {
    ...
    public AnalysisUploadDeleteRequest withProjectVersionId(ProjectIdentifier value) {
