...
@XmlRootElement(name = "GroupingValuesRequest")
public class GroupingValuesRequest
    extends ManagedSessionRequest
{
     ...
     * 
     */
    public GroupingValuesRequest(final String sessionId, final ProjectIdentifier projectIdentifier, final IssueListDescription issueListDescription) {
        super(sessionId);
    ...
    public GroupingValuesRequest withProjectIdentifier(ProjectIdentifier value) {
        setProjectIdentifier(value);
        return this;
    }

    public GroupingValuesRequest withIssueListDescription(IssueListDescription value) {
        setIssueListDescription(value);
        return this;
    }

    @Override
    public GroupingValuesRequest withSessionId(String value) {
        setSessionId(value);
        return this;
    }
