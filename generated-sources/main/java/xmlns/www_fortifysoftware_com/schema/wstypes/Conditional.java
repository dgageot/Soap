...
/**
 * Defines a condition or set of conditions that
...
public class Conditional {
     ...
     * 
     */
    public Conditional(final And and, final Or or, final Not not, final RuleCondition ruleCondition) {
        this.and = and;
        this.or = or;
        this.not = not;
    ...
    public Conditional withAnd(And value) {
        setAnd(value);
        return this;
    }

    public Conditional withOr(Or value) {
        setOr(value);
        return this;
    }

    public Conditional withNot(Not value) {
        setNot(value);
        return this;
    }

    public Conditional withRuleCondition(RuleCondition value) {
