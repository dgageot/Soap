...
@XmlRootElement(name = "GetAuthenticationTokenRequest")
public class GetAuthenticationTokenRequest {
     ...
     * 
     */
    public GetAuthenticationTokenRequest(final String tokenType, final BigInteger daysToLive) {
    ...
    public GetAuthenticationTokenRequest withTokenType(String value) {
        setTokenType(value);
        return this;
    }

    public GetAuthenticationTokenRequest withDaysToLive(BigInteger value) {
        setDaysToLive(value);
        return this;
    }
