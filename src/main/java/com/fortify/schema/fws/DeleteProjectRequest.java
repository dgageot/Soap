...
@XmlRootElement(name = "DeleteProjectRequest")
public class DeleteProjectRequest {
     ...
     * 
     */
    public DeleteProjectRequest(final List<Long> projectId) {
    ...
    public DeleteProjectRequest withProjectId(Long... values) {
        if (values!= null) {
    ...
    public DeleteProjectRequest withProjectId(Collection<Long> values) {
        if (values!= null) {
    ...
    public DeleteProjectRequest withProjectId(List<Long> projectId) {
