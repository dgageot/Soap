...
@XmlRootElement(name = "FPRUploadRequest")
public class FprUploadRequest {
     ...
     * 
     */
    public FprUploadRequest(final ProjectIdentifier projectVersionId, final String filename, final Boolean expectsAttachment) {
    ...
    public FprUploadRequest withProjectVersionId(ProjectIdentifier value) {
        setProjectVersionId(value);
        return this;
    }

    public FprUploadRequest withFilename(String value) {
        setFilename(value);
        return this;
    }

    public FprUploadRequest withExpectsAttachment(Boolean value) {
