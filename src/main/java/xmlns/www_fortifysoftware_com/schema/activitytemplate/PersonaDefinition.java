...
public class PersonaDefinition {
     ...
     * 
     */
    public PersonaDefinition(final List<Persona> persona) {
    ...
    public PersonaDefinition withPersona(Persona... values) {
        if (values!= null) {
    ...
    public PersonaDefinition withPersona(Collection<Persona> values) {
        if (values!= null) {
    ...
    public PersonaDefinition withPersona(List<Persona> persona) {
        setPersona(persona);
        return this;
    }
