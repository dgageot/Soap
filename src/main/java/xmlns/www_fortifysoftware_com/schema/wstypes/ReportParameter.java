...
public class ReportParameter {
     ...
     * 
     */
    public ReportParameter(final ReportParamType reportParamType, final String name, final String description, final String identifier) {
    ...
    public ReportParameter withReportParamType(ReportParamType value) {
        setReportParamType(value);
        return this;
    }

    public ReportParameter withName(String value) {
        setName(value);
        return this;
    }

    public ReportParameter withDescription(String value) {
        setDescription(value);
        return this;
    }

    public ReportParameter withIdentifier(String value) {
        setIdentifier(value);
        return this;
    }
